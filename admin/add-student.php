...
<?php 
	if(isset($_POST['submit'])) {
		...
		if($rank1 == 'one') {
			$query = "INSERT INTO users (id, name, surname, class, division, roll no, email, username, password, rank, level) VALUES ('" . $uid . "', '" . $name1 . "', '" . $sname1 . "', '" . $email1 . "', '" . $username1 . "', '" . $password1 . "', 'student', '" . $level1 . "')";
		}
