				      ...
				      <div class="col-md-9 personal-info">
				        ...
				        <form class="form-horizontal" role="form" method="post">
						  ...
						  <div class="form-group">
				            ...
				            <div class="col-md-8">
				              <input class="form-control" type="sem" id="sem" name="sem" required>
				            </div>
							</div>
							<div class="form-group">
				            <label class="col-md-3 control-label">Class:</label>
				            <div class="col-md-8">
				              <input class="form-control" type="class" id="class" name="class" required>
				            </div>
							</div>
							<div class="form-group">
				            <label class="col-md-3 control-label">Division:</label>
				            <div class="col-md-8">
				              <input class="form-control" type="div" id="div" name="div" required>
				            </div>
							</div>
							<div class="form-group">
				            <label class="col-md-3 control-label">Roll No.:</label>
				            <div class="col-md-8">
				              <input class="form-control" type="rno" id="rno" name="rno" required>
				            </div>
							</div>
							<div class="form-group">
				            <label class="col-md-3 control-label">Branch:</label>
				            <div class="col-md-8">
				              <input class="form-control" type="branch" id="branch" name="branch" required>
				            </div>
							</div>
		          		  <div class="form-group">
...
<?php 
	if(isset($_POST['submit'])) {
		...
		$class1 = mysqli_real_escape_string($conn, $_REQUEST['class']);
		$div1 = mysqli_real_escape_string($conn, $_REQUEST['div']);
		$sem1 = mysqli_real_escape_string($conn, $_REQUEST['sem']);
		$rno1 = mysqli_real_escape_string($conn, $_REQUEST['rno']);
		$branch1 = mysqli_real_escape_string($conn, $_REQUEST['branch']);
		...
		if($rank1 == 'one') {
			$query = "INSERT INTO users (id, name, surname, email, username, password, rank, level, class, division, semester, rollno, branch) VALUES ('" . $uid . "', '" . $name1 . "', '" . $sname1 . "', '" . $email1 . "', '" . $username1 . "', '" . $password1 . "', 'student', '" . $level1 . "')";
		}
