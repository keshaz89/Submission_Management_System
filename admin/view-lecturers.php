            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Lab No." disabled></th>
                ...
                <tbody>
                    <?php
                        ...
                        {
                          $query = "SELECT * FROM users WHERE rank='lecturer' ORDER BY id asc";
                        }
