	...
	<body>
		...
		<hr>
            ...
            <div class="panel-heading" style="background-color: #800000;">
                <h3 class="panel-title" style="font-size:2.7rem;">Theory Subjects</h3>
            </div>
            <table class="table">
                <thead>
                    <tr class="filters">
                ...
                <tbody>
                	<?php 
						...
						$query = "SELECT * FROM module"; // SEARCHES THE 'module' TABLE BASED ON THE 'level' IN 'users' TABLE
            ...
            <div class="panel panel-primary filterable" style="border-color: #800000;">
            <div class="panel-heading" style="background-color: #800000;">
			<h3 class="panel-title" style="font-size:2.7rem;">Practical Subjects</h3>
            </div>
            <table class="table">
                <thead>
                    <tr class="filters">
