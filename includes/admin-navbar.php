...
<nav id="navbar">
    ...
    border-radius: 10px; float: left;"></li>
        <li class="item"><a href="../home/adminHome.php">Home</a></li>
        <li>
        <?php
    ...
    <div id="menu">
        ...
        <br><a href="../admin/add-user.php">Add User</a>
        <br><a href="../admin/add-module.php">Add Subject</a>
        <br><a href="../admin/view-users.php">View Users</a>
        <br><a href="../admin/view-students.php">View Students</a>
        <br><a href="../admin/view-lecturers.php">View Faculties</a>
