...
<nav id="navbar">
    ...
    border-radius: 10px; float: left;"></li>
        <li class="item"><a href="../home/lecturerHome.php">Home</a></li>
        <li>
        <?php
    ...
    <div id="menu">
        <br><a href="../lecturer/add-mark.php">Add Marks</a>
        <br><a href="../lecturer/view-marks.php">View Marks</a>
        <br><a href="../lecturer/view-students.php">View Students</a>
        <br><a href="../home/tt2.php">View Timetable</a>
        <br><a href="../lecturer/add-reminders.php">Set Reminders</a>
